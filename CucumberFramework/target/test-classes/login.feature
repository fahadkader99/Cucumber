...
Feature: This feature is to test the login functionality
  ...
  #Background: Login with a valid user credentials
  ...
  # Login with blank credentials
    ...
    @Smoke @Fahad @datadriven  # Data driven Testing
    Scenario Outline: Verify user is unable to login with invalid credentials
      When user enter username "<username>" and password "<password>"
      And Click on the login button
      Then verify invalid login error message "Invalid Credentials" is displayed
...
# Data driven test by passing data table
      @DataTable
